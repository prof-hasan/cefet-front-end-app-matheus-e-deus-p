...
1. Armazenamento de dados usando [_web storage_](https://fegemo.github.io/cefet-front-end/classes/js5/) ([veja aula](https://www.youtube.com/watch?v=4DNvYQkh3TM&list=PLNaBD3CnN0-8b7lNxYp5GP_uajyFRn2ek&index=88)). Por exemplo:
...
1. Uso de (pelo menos) uma [biblioteca JavaScript](https://fegemo.github.io/cefet-front-end/classes/js6) ([veja video aula](https://www.youtube.com/watch?v=3naIP3MD1H8&list=PLNaBD3CnN0-8b7lNxYp5GP_uajyFRn2ek&index=92))
...
1. (3 a 10%) Deixar o site 100% acessível para cegos
